...
def collect_parameters(filename):
    # f"./results/celebA/{num_tasks}_{ways_num_classes_per_task}_{shots_num_samples_per_class}_"
...
def calc_avg_std(data, rolling_average):
    train_err = [z[1] for z in data]
    train_acc = [z[2] for z in data]
    val_err = [c[3] for c in data]
    val_acc = [c[4] for c in data]
    ...
    return avg_train_err, std_train_err, avg_train_acc, std_train_acc, avg_val_err, std_val_err, avg_val_acc, std_val_acc
